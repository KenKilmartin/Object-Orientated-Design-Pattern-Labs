...
implements ActionListener {
    ...
    private void setCenter() {
        ...
        centerPlant += garden.getCenter().getSoil();
    ...
    private void setBorder() {
        ...
        borderPlant += garden.getBorder().getSoil();
        gardenPlot.repaint();
    ...
    private void setShade() {
        ...
        shadePlant += garden.getShade().getSoil();
...
//--------------------------------
    ...
    class TreeListener implements ItemListener {
        public void itemStateChanged(ItemEvent e) {
			// creating an instance of garden as treeGarden
