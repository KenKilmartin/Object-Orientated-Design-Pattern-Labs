   ...
   implements ActionListener
{
   ...
   public tCommand()
   {
      ...
      mnuFile.add(mnuExit);
      displayFile = new MenuCommand("Display"); 
      mnuFile.add(displayFile);

      displayFile.addActionListener(this);
      ...
      p = new Panel();
      add(p);
      p.add(btnRed,BorderLayout.NORTH);
   ...
   class MenuCommand extends MenuItem implements Command
   {
      public MenuCommand(String caption)
      {
         super(caption);
      }
      public void Execute()
