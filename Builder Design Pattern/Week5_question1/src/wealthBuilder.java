...
public class wealthBuilder extends JxFrame 
  implements ListSelectionListener, ActionListener {
    ...
    private Vector Bonds, Stocks, Mutuals, JapaneseStocks;   //3 lists of investments
    ...
    private void stockList_Click() {
        ...
        System.out.print(mchoice.getClass().toString());
    ...
    private void buildStockLists() {
        ...
        JapaneseStocks = new Vector();
        JapaneseStocks.addElement("Manga");
        JapaneseStocks.addElement("Sushi");
        JapaneseStocks.addElement("Cherry Blossom music");
        JapaneseStocks.addElement("Japense POP");
        JapaneseStocks.addElement("Volcano");
        JapaneseStocks.addElement("Nagano");
